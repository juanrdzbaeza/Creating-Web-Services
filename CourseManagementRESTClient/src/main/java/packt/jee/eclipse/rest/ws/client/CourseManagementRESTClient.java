...
/**
 * Esta es una clase de prueba simple para invocar el servicio 
 * web REST utilizando las API de cliente JAX-RS.
 */
public class CourseManagementRESTClient {
	...
	public static void testAddCourseForm() {
		...
		//Get WebTarget for a URL
		WebTarget webTarget =
		client.target("http://localhost:8080/CourseManagementREST/services/course/add");
